...
function SessionHarness() {
  ...
  return (
    <>
      <span data-testid="session-filename">{session.fileName}</span>
...
`,
  ...
  it('shows the opened filename in the window drag region', async () => {
    ...
    expect(await screen.findByTestId('session-filename')).toHaveTextContent(
      'existing.fountain',
    );
  });
